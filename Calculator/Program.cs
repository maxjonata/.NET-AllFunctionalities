namespace CalculatorCmd {
  class Calculator {
    ...
    public static decimal GenericCalculation(Func<decimal,decimal,decimal> operation, params List<decimal> numbers) {
      decimal finalNumber;
    ...
    {
      Console.WriteLine("GenericCalculation addition 2+3 = " + Calculator.GenericCalculation((x, y) => x + y, [2m,3m]));
      Console.WriteLine("GenericCalculation subtraction 2-3 = " + Calculator.GenericCalculation((x, y) => x - y, [2m,3m]));
      Console.WriteLine("GenericCalculation multiplication 2*3 = " + Calculator.GenericCalculation((x, y) => x * y, [2m,3m]));
      Console.WriteLine("GenericCalculation Division 2/3 = " + Calculator.GenericCalculation((x, y) => x / y, [2m,3m]));
